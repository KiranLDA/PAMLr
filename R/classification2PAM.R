...
classification2PAM <- function(from, to, classification, addTO, missing = NA ){
  print("Error: This function is deprecated, use create_merged_classification in latest version of PAMLr which can be installed by running devtools::install_github('KiranLDA/PAMLr')")
