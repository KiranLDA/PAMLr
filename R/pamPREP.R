...
pamPREP <- function(dta,
                    ...
                    interp = FALSE,
                    tz="UTC"){
  print("Error: This function is deprecated, use create_summary_statistics in latest version of PAMLr which can be installed by running devtools::install_github('KiranLDA/PAMLr')")
