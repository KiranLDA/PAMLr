...
#' @export
triMAG <- function(dta){
  print("Error: This function is deprecated, use calculate_triaxial_magnetic in latest version of PAMLr which can be installed by running devtools::install_github('KiranLDA/PAMLr')")
